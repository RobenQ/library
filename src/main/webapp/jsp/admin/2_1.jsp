...
<html>
	<head>
		...
		<script src="/library/js/admin/2_1.js" type="text/javascript"></script>
	</head>
	<body>
		<div id="head">
		...
		<iframe id="ifa" src="/library/admin/to2_1a" width="100%" height="497px"></iframe>
	</body>
</html>
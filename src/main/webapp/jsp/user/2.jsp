...
<html>
	<head>
		<meta charset="utf-8">
		<title></title>
		<link rel="stylesheet" type="text/css" href="/library/css/user/2.css"/>
		<script src="/library/js/user/2.js" type="text/javascript"></script>
	</head>
	<body>
		<div id="head">
		...
		<iframe id="ifa" src="/library/user/to2a" width="100%" height="497px"></iframe>
	</body>
</html>
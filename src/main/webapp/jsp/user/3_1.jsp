...
<html>
	<head>
		<meta charset="utf-8" />
		<title></title>
		<link href="/library/css/user/3_1.css" rel="stylesheet" />
		<script src="/library/js/user/3_1.js" type="text/javascript"></script>
	</head>
	<body>
		<div class="list">
			...
			借书证编号:&nbsp;&nbsp;<input type="text" readonly="readonly" class="att" name="isbn" id="isbn" value="${user.barcode }"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			借阅数量:<input type="text" readonly="readonly" class="att" name="num" id="num" value="${user.bollowed }"/><br />
			账号:<input type="text" class="att" name="page" id="page" value="${user.account }"/><br />
			<button id="btn" onclick="xg(this)" uuid="${user.id }">确认修改</button>
		</div>
	</body>
</html>